          ...
          <Flex className="mt-[150px] items-center justify-between">
            <div
              className="w-[650px] h-[600px] overflow-y-scroll rounded-2xl
                ...
                bg-[#0f0f1a]/50 backdrop-blur-md border-2 border-[#00C0FF]/30 
                custom-scrollbar"
            >
            ...
            <div>
              <p className="font-primary text-2xl font-semibold text-[#00C0FF] mb-7">Website Design</p>
              ...
              <button className="w-[50px] h-[50px] rounded-full bg-[#00C0FF] cursor-pointer flex items-center justify-center mt-12 animate-bounce">
