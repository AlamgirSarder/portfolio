...
const Project = () => {
  return (
    <div className="bg-basecolor pb-20 md:pb-28">
      <Container>
        <div>
          <p className="font-primary text-2xl font-semibold text-primary text-center mb-6">
            Latest Works
          </p>
          <h2 className="font-primary font-semibold text-2xl md:text-[64px] text-white md:w-[900px] mx-auto text-center leading-[123%]">
            Explore My Popular Projects
          </h2>

          <Flex className="mt-13 md:mt-[150px] items-center justify-between flex-col md:flex-row gap-y-5 md:gap-y-0">
            <div
              className="md:w-[650px] h-[400px] md:h-[600px] overflow-y-scroll rounded-2xl
            ...
            <div>
              <p className="font-primary text-2xl font-semibold text-primary mb-7">
                Website Design
              </p>
              <h3 className="font-primary font-bold text-3xl md:text-5xl text-white md:w-[600px] mb-8">
                A Simple Website Design with Figma
              </h3>
              <p className="md:w-[392px] font-primary text-[#B4AFC6] text-lg">
          ...
          <Flex className="mt-13 md:mt-[150px] items-center justify-between  md:flex-row gap-y-5 md:gap-y-0 flex-col-reverse">
            <div>
              <p className="font-primary text-2xl font-semibold text-primary mb-7">
                Website Design
              </p>
