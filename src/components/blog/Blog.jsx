...
const Blog = () => {
  ...
  return (
    <div className='bg-basecolor'>
        <Container>
            <div className='pb-20 md:pb-[156px]'>
                  <p className="font-primary text-2xl font-semibold text-primary text-center mb-6">
              Blog
            </p>
            <h2 className="font-primary font-semibold text-2xl md:text-[64px] text-white md:w-[783px] mx-auto text-center leading-[123%] mb-24">
              Latest Blog Posts
            </h2>

            <Flex className='justify-between flex-col md:flex-row gap-5 md:gap-0'>

                {
                    blog_card.map((item,i)=>(
                        <div key={i}>
                            <div className='md:w-[423px] h-[258px] rounded-tl-2xl rounded-tr-2xl'>
                                <img src={item.img} alt="blog image" className='w-full h-full rounded-tl-2xl rounded-tr-2xl' />
                            </div>
                            <div className='md:w-[423px] h-[200px] bg-[#432D92] rounded-bl-2xl rounded-br-2xl pt-[22px] pl-11'>
