    ...
    <div>
         <div className="relative">
                    <input
                      type="text"
                      id="feild_id"
                      className="block w-[300px] px-[26px] py-[26px] text-xl text-[#B4AFC6] font-primary font-semibold rounded-lg border border-[#00C0FF] appearance-none focus:outline-none focus:border-white peer shadow-lg shadow-[#00C0FF]/10"
                      placeholder=" "
                    />
                    <label
                      for="feild_id"
